...
CucumberKW.runFeatureFile('Include/features/AP-5 Aldiransyah Rizky Putra - TC-Get Single User.feature')

response = WS.sendRequest(findTestObject('Users/GET/GET Single User'))
